...
- In this episode, you'll discover how to work with MongoDB using Mongoose, a powerful ORM for NodeJS.
- We cover creating schemas to define your data structure and models to interact with the database.
- This tutorial will teach you how to organize your database for efficiency and scalability, providing a solid foundation for handling data in your application.

- `npm i mongoose`
- First connect with db then listen to requests
