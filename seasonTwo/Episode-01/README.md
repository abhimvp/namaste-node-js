# Season 2 | Episode-01 | Microservices vs Monolith - How to Build a Project

- Explore the key differences between microservices and monolithic architectures in this episode.
- Learn the pros and cons of each, and understand when to choose one over the other based on the requirements of your project.
- This video covers architectural design decisions that can significantly impact scalability, performance, and maintainability, preparing you to make informed choices when building backend systems.
